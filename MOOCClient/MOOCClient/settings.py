# Django settings for MOOCClient project.
import os
...
STATICFILES_DIRS = (
    ...
    os.path.join(os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir)), 'static').replace('\\','/'),
)
